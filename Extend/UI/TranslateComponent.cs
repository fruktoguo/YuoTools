        ...
        public void Translate()
        {
            switch (TranslateType)
            {
                ...
                case TranslateType.Text:
                    GetComponent<Text>().text = TranslateManager.Get.LoadText(ID);
                    break;
                case TranslateType.TextMeshProUGUI:
                    GetComponent<TextMeshProUGUI>().text = TranslateManager.Get.LoadText(ID);
                    break;
                case TranslateType.Image:
                    imageComponent = GetComponent<Image>();
                    var sprite = TranslateManager.Get.LoadSprite(ID);
                    //如果没找到图片，就用默认图片
