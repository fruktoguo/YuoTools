...
namespace YuoTools.Deprecated
{
    public static class YuoDelayForJobsEx
    {
        ...
        {
            YuoDelayManager.Instance.StartCoroutine(IYuoDelayDForJob(jobData.Schedule(arrayLength, innerloopBatchCount), OnCompleted));
        }

        public static void YuoSchedule<T>(this T jobData, UnityAction OnCompleted) where T : struct, IJob
        {
            YuoDelayManager.Instance.StartCoroutine(IYuoDelayDForJob(jobData.Schedule(), OnCompleted));
        }
        ...
        {
            YuoDelayManager.Instance.StartCoroutine(IYuoDelayDForJob(jobData, OnCompleted, OnEnd));
        }
        ...
        public static void YuoSchedule<T>(this List<T> jobData, UnityAction<int> OnCompleted, UnityAction OnEnd) where T : struct, IJob
        {
            ...
            YuoDelayManager.Instance.StartCoroutine(IYuoDelayDForJob(handles, OnCompleted, OnEnd));
        }
